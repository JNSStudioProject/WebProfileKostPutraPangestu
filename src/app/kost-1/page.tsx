        ...
        <div className="container">
          <div className="hero-content" style={{ width: '100%', textAlign: 'center', paddingRight: 0 }}>
            ...
            <p className="hero-desc" style={{ margin: '1.5rem auto 0' }}>
              Markas ideal dengan fasilitas lengkap untuk mendukung produktivitas dan kenyamanan beristirahatmu.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '3rem', alignItems: 'start' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
              <div className="card">
                <h3 className="mb-4 text-primary" style={{ marginBottom: '1rem' }}>Lokasi Markas 1.0</h3>
