    ...
    <main>
      ...
      <nav className="navbar container">
        ...
        <ul className="nav-links">
          ...
          <li><Link href="/kost-2" className="nav-link active">Kost 2.0</Link></li>
        </ul>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '3rem', alignItems: 'start' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
              ...
              <div className="card" style={{ background: 'linear-gradient(135deg, var(--bg-card), var(--bg-secondary))', border: '1px solid var(--accent-color)' }}>
                <h3 className="mb-4 text-accent" style={{ marginBottom: '1rem' }}>Tertarik dengan Kost 2.0?</h3>
